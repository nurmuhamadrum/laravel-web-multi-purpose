        ...
        <div id="header" class="bg-[#F6F7FA] relative overflow-hidden">
            <div class="container max-w-[1130px] mx-auto relative pt-10 z-10">
                ...
                @forelse ($heroSections as $heroSection)
                    <input type="hidden" id="path_video" value="{{ $heroSection->path_video }}">
                    <div id="Hero" class="flex flex-col gap-[30px] mt-20 pb-20">
                        ...
                        <div class="flex flex-col gap-[10px]">
                            <h1 class="font-extrabold text-[50px] leading-[65px] max-w-[536px]">{{ $heroSection->heading }}
                            </h1>
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <button
                                ...
                                <div class="w-6 h-6 flex shrink-0 overflow-hidden">
                                    <img src="assets/icons/play-circle.svg" class="w-full h-full object-contain"
                                        alt="icon">
                                </div>
