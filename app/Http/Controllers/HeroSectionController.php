...
class HeroSectionController extends Controller
{
    ...
    public function store(StoreHeroSectionRequest $request)
    {
        ...
        return redirect()->route('admin.hero_sections.index')->with('success', 'Hero created successfully.');
    }
    ...
    public function update(UpdateHeroSectionRequest $request, HeroSection $heroSection)
    {
        ...
        return redirect()->route('admin.hero_sections.index')->with('success', 'Hero update successfully.');
    }
    ...
    public function destroy(HeroSection $heroSection)
    {
        ...
        return redirect()->route('admin.hero_sections.index')->with('success', 'Hero deleted successfully.');
    }
}
